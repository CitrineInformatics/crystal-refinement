...
class OptimizerIteration:
    ...
    """
    def __init__(self, parent, ins_file, res_file):
    ...
    def propagate(self):
        new_child = OptimizerIteration(self, self.get_ins(), self.get_res())
...
class OptimizerHistory:
    ...
    def run_iter(self, ins_file, parent_iteration):
        """
    ...
    def get_best_history(self):
        return sorted(self.leaves, key=lambda iteration: iteration.r1)[0].get_full_history()
